...
const isMouthOpen = (rekObj) => (rekObj&&rekObj.MouthOpen&&rekObj.MouthOpen.Value===true)?true:false;

//Detect if the person in the image has the eyes open.
const isEyesOpen = (rekObj) => (rekObj&&rekObj.EyesOpen&&rekObj.EyesOpen.Value===true)?true:false;

//Detct if the person has the eyes closed.
const isEyesClosed = (rekObj) => (rekObj&&rekObj.EyesOpen&&rekObj.EyesOpen.Value===false)?true:false;

//Detect if the person in the face is sminling.
const isSmiling = (rekObj) => (rekObj&&rekObj.Smile&&rekObj.Smile.Value===true)?true:false;
...
const useGlasses = (rekObj) => (rekObj&&rekObj.Eyeglasses&&rekObj.Eyeglasses.Value===true)?true:false;

//Detect if the persons uses sun glasess.
const useSunGlasses = (rekObj) => (rekObj&&rekObj.Sunglasses&&rekObj.Sunglasses.Value===true)?true:false;
